...
export default function AnalogPath() {
  ...
  useEffect(() => {
    fetch("/data/analog-sublevels.json")
      .then(r => r.json())
      .then(setAnalogSubLevels)
      .catch(console.error);
  }, []);
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <div style={{ display: "flex", gap: "10px", marginTop: "12px", flexWrap: "wrap" }}>
              ...
              <div style={{ background: "rgba(245,158,11,0.1)", border: "1px solid rgba(245,158,11,0.2)", borderRadius: "999px", padding: "3px 12px", fontSize: "10.5px", fontFamily: "'DM Mono',monospace", color: "#f59e0b", fontWeight: 700 }}>
